...
def clean_type(p_type):
    ...
    condos = ['condominio', 'casa-en-condominio', 'apartment',
              'condo/apartment', 'apartment building', 'whole apartment building']
    ...
    commercial = ['locales comerciales', 'local comercial', 'plaza', 'plazuela', 'house with commercial space',
                  'sale of business']
    unspecified = ['local']
    if lower in casas:
        return 'Casa'
...
# noinspection SpellCheckingInspection
def clean_dept(dept):
    santacruz = ['santa cr', 'santa cruz de la sierra', 'warnes', 'camiri', 'montero', 'la guardia', 'porongo',
                 'portachuelo', 'san javier']
    lapaz = ['el alto']
    cochabamba = ['cochabam']
