...
def Get_Remax_Data():#browser):
	...
	for page_num in range(1, num_pages+1):
		...
		remax_urls_dirty = browser.find_elements_by_xpath("/html/body/div/form/div/div/div/div/div/div/div/div/div/div/div/div/div/div/a[@href]")
...
# css_selector = "div.gallery-map-map div[class^='googlemap-office'] script"
# location = browser.find_element_by_css_selector(css_selector)
# print(type(location.get_property('innerHTML')))
