...
def Search_Ultracasas(browser):
	...
	buttons = browser.find_elements_by_xpath("//html/body/div[1]/section[2]/div/div/div[1]/aside[1]/div[2]/form/div[2]/div/label[@class ='checkbox-inline no-padding']")
...
def Extract_Data(browser):
	...
	return Listing.Listing(url, prop_type, price, desc, bathrooms, bedrooms, built_area, lot_size, year, dept, agent, lat, lon)
